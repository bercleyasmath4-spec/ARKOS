  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-8">
      <GlassCard className="h-32 flex flex-col justify-center">
        ...
        <span className="text-[10px] font-bold tracking-widest text-white/50 mb-2">PRIORITY ONE</span>
        <h3 className="text-xl font-semibold text-white">{priorityTask.title}</h3>
        <p className="text-sm text-cyan-400">{priorityTask.time}</p>
      </GlassCard>

      <GlassCard className="h-32 flex flex-col justify-center">
        <span className="text-[10px] font-bold tracking-widest text-white/50 mb-2">BUDGET SNAPSHOT</span>
